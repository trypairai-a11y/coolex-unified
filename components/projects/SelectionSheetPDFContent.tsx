...
// Register standard fonts (safe here — this module is only loaded client-side via dynamic import)
...
// Default export: the PDFViewer wrapper (used by dynamic import in SelectionSheetDialog)
export default function SelectionSheetPDFContent({ project }: { project: Project }) {
  return (
