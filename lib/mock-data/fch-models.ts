...
//   • Entering / leaving water 44 / 54 °F          (6.7 / 12.2 °C)
//
...
export const FCH_RATING_NOTE =
  'Data based on 80/67 °F (26.7/19.4 °C) air on-coil DBT/WBT and 44/54 °F (6.7/12.2 °C) entering/leaving water temperature.';
...
const RAW_2ROW: Record<string, SpeedRows> = {
  ...
  '10': {
    HI:  [[26708, 19448, 5.34, 11.5], [24429, 17610, 4.89, 9.83], [20804, 14750, 4.16, 7.4]],
    MED: [[25684, 18631, 5.14, 10.67], [23507, 16888, 4.7, 9.19], [20236, 14317, 4.05, 7.05]],
  ...
  '14': {
    HI:  [[33792, 24577, 6.76, 20.43], [31292, 22552, 6.26, 17.85], [27986, 19922, 5.6, 14.67]],
    MED: [[32759, 23750, 6.55, 19.37], [30295, 21767, 6.06, 16.85], [26912, 19096, 5.38, 13.69]],
    LOW: [[31595, 22825, 6.32, 18.18], [28986, 20744, 5.8, 15.59], [25462, 17990, 5.09, 12.42]],
  },
  '16': {
    HI:  [[40235, 29501, 8.05, 17], [38245, 27869, 7.65, 15.55], [34494, 24838, 6.9, 12.97]],
    MED: [[39594, 28981, 7.92, 16.08], [37388, 27182, 7.48, 14.97], [33429, 24003, 6.69, 12.27]],
    LOW: [[38720, 28276, 7.74, 15.82], [36586, 26542, 7.32, 14.38], [33002, 23669, 6.6, 12]],
  },
  '20': {
    HI:  [[47767, 34947, 9.55, 17.74], [45485, 33082, 9.1, 15.36], [42727, 30581, 8.55, 13.76]],
    MED: [[46561, 33974, 9.31, 16.97], [44306, 32141, 8.86, 14.66], [41790, 29848, 8.36, 14.14]],
    LOW: [[45394, 33035, 9.08, 16.23], [43066, 31155, 8.61, 14.02], [40381, 28751, 8.08, 13.3]],
  },
};
...
const RAW_3ROW: Record<string, SpeedRows> = {
  '08': {
    HI:  [[34271, 23770, 6.85, 8.74], [30993, 21300, 6.2, 7.32], [25862, 17518, 5.17, 5.32]],
    MED: [[33137, 22910, 6.63, 8.23], [29993, 20555, 6, 6.91], [25313, 17120, 5.06, 5.12]],
    LOW: [[31504, 21682, 6.3, 7.53], [28116, 19166, 5.62, 6.16], [22920, 15398, 4.58, 4.3]],
  },
  '10': {
    HI:  [[35351, 24594, 7.07, 9.28], [32008, 22060, 6.4, 7.74], [26766, 18177, 5.35, 5.65]],
    MED: [[33996, 23561, 6.8, 8.61], [30800, 21156, 6.16, 7.24], [26035, 17644, 5.21, 5.38]],
    LOW: [[32132, 22154, 6.43, 7.8], [28691, 19591, 5.74, 6.39], [23429, 15762, 4.69, 4.47]],
  },
  '12': {
    HI:  [[42133, 29375, 8.43, 9.58], [38649, 26721, 7.73, 8.23], [34109, 23326, 6.82, 6.6]],
    MED: [[41085, 28571, 8.22, 9.16], [37585, 25919, 7.52, 7.83], [33014, 22517, 6.6, 6.23]],
    LOW: [[39864, 27642, 7.97, 8.69], [36237, 24909, 7.25, 7.34], [31436, 21359, 6.29, 5.73]],
  },
  '14': {
    HI:  [[43181, 30181, 8.64, 9.99], [39649, 27478, 7.93, 8.61], [35022, 24002, 7, 6.92]],
    MED: [[41861, 29165, 8.37, 9.47], [38386, 26221, 7.68, 8.13], [33678, 23007, 6.74, 6.46]],
    LOW: [[40373, 28029, 8.07, 8.89], [36727, 25275, 7.35, 7.52], [31866, 21674, 6.37, 5.86]],
  },
  '16': {
    HI:  [[54633, 38136, 10.93, 17.32], [51630, 35827, 10.33, 15.68], [46019, 31578, 9.2, 12.8]],
    MED: [[53762, 37464, 10.75, 16.38], [50473, 34944, 10.09, 14.99], [44598, 30517, 8.92, 12.11]],
    LOW: [[52576, 36552, 10.52, 16.12], [49390, 34121, 9.88, 14.5], [44028, 30092, 8.81, 11.84]],
  },
  '20': {
    HI:  [[63678, 44480, 12.74, 13.6], [60304, 41887, 12.06, 12.36], [56248, 38805, 11.25, 10.24]],
    MED: [[62070, 43241, 12.41, 13.01], [58741, 40695, 11.75, 11.8], [55014, 37875, 11, 10.52]],
    LOW: [[60514, 42047, 12.1, 12.44], [57097, 39447, 11.42, 11.28], [53159, 36483, 10.63, 9.9]],
  },
};
