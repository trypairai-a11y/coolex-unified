...
const RAW: Record<string, Record<string, Record<string, ACCBPPerformancePoint>>> = {
  'ACC-03': {
    '4.5': {
      ...
      '46': { capacityKW: 8.7, compressorKW: 3.6, waterFlowLPS: 0.4, waterPressureDropKPa: 12.4 },
      '48': { capacityKW: 8.7, compressorKW: 3.7, waterFlowLPS: 0.4, waterPressureDropKPa: 11.7 },
    ...
    '5.6': {
      ...
      '48': { capacityKW: 8.7, compressorKW: 3.8, waterFlowLPS: 0.4, waterPressureDropKPa: 13.1 },
    ...
    '7.8': {
      ...
      '48': { capacityKW: 10.0, compressorKW: 3.8, waterFlowLPS: 0.4, waterPressureDropKPa: 15.9 },
    ...
    '8.8': {
      ...
      '46': { capacityKW: 10.4, compressorKW: 3.7, waterFlowLPS: 0.4, waterPressureDropKPa: 17.3 },
      '48': { capacityKW: 10.4, compressorKW: 3.8, waterFlowLPS: 0.4, waterPressureDropKPa: 17.3 },
    ...
    '10': {
      ...
      '52': { capacityKW: 10.0, compressorKW: 4.2, waterFlowLPS: 0.4, waterPressureDropKPa: 15.2 },
    },
  },
  'ACC-04': {
    '4.5': {
    ...
    '5.6': {
      ...
      '46': { capacityKW: 11.9, compressorKW: 4.8, waterFlowLPS: 0.5, waterPressureDropKPa: 13.8 },
      '48': { capacityKW: 11.4, compressorKW: 5.2, waterFlowLPS: 0.5, waterPressureDropKPa: 13.1 },
      '52': { capacityKW: 11.4, compressorKW: 5.3, waterFlowLPS: 0.5, waterPressureDropKPa: 12.4 },
    },
    '6.7': {
    ...
    '8.8': {
      ...
      '46': { capacityKW: 13.6, compressorKW: 4.9, waterFlowLPS: 0.6, waterPressureDropKPa: 17.3 },
      '48': { capacityKW: 13.2, compressorKW: 5.1, waterFlowLPS: 0.6, waterPressureDropKPa: 16.6 },
      '52': { capacityKW: 12.5, compressorKW: 5.5, waterFlowLPS: 0.5, waterPressureDropKPa: 14.5 },
    },
    '10': {
      '35': { capacityKW: 15.7, compressorKW: 3.9, waterFlowLPS: 0.7, waterPressureDropKPa: 22.8 },
      '40': { capacityKW: 14.8, compressorKW: 4.4, waterFlowLPS: 0.7, waterPressureDropKPa: 18.6 },
  ...
  'ACC-05': {
    ...
    '5.6': {
      ...
      '40': { capacityKW: 16.5, compressorKW: 5.2, waterFlowLPS: 0.7, waterPressureDropKPa: 25.5 },
      '46': { capacityKW: 15.2, compressorKW: 5.9, waterFlowLPS: 0.7, waterPressureDropKPa: 23.5 },
      '48': { capacityKW: 14.9, compressorKW: 6.1, waterFlowLPS: 0.6, waterPressureDropKPa: 22.1 },
      '52': { capacityKW: 15.0, compressorKW: 6.6, waterFlowLPS: 0.6, waterPressureDropKPa: 19.3 },
    },
    '6.7': {
      ...
      '52': { capacityKW: 15.6, compressorKW: 6.6, waterFlowLPS: 0.7, waterPressureDropKPa: 22.1 },
    },
    '7.8': {
    ...
    '8.8': {
      ...
      '40': { capacityKW: 18.0, compressorKW: 5.3, waterFlowLPS: 0.7, waterPressureDropKPa: 31.8 },
    ...
    '10': {
      ...
      '40': { capacityKW: 19.8, compressorKW: 5.3, waterFlowLPS: 0.8, waterPressureDropKPa: 33.8 },
      ...
      '52': { capacityKW: 17.0, compressorKW: 6.8, waterFlowLPS: 0.7, waterPressureDropKPa: 26.2 },
    },
  },
  'ACC-07': {
    '4.5': {
      ...
      '46': { capacityKW: 20.1, compressorKW: 8.0, waterFlowLPS: 0.8, waterPressureDropKPa: 14.5 },
      '48': { capacityKW: 19.6, compressorKW: 8.1, waterFlowLPS: 0.8, waterPressureDropKPa: 13.8 },
    ...
    '5.6': {
      ...
      '40': { capacityKW: 22.4, compressorKW: 7.0, waterFlowLPS: 0.9, waterPressureDropKPa: 18.0 },
      '46': { capacityKW: 21.0, compressorKW: 8.0, waterFlowLPS: 0.9, waterPressureDropKPa: 15.9 },
      '48': { capacityKW: 20.5, compressorKW: 8.2, waterFlowLPS: 0.9, waterPressureDropKPa: 15.2 },
      '52': { capacityKW: 19.7, compressorKW: 8.8, waterFlowLPS: 0.8, waterPressureDropKPa: 13.8 },
    },
    '6.7': {
      '35': { capacityKW: 24.7, compressorKW: 6.3, waterFlowLPS: 1.1, waterPressureDropKPa: 21.4 },
      '40': { capacityKW: 23.5, compressorKW: 7.1, waterFlowLPS: 1.0, waterPressureDropKPa: 19.3 },
      '46': { capacityKW: 21.9, compressorKW: 7.9, waterFlowLPS: 0.9, waterPressureDropKPa: 18.0 },
      '48': { capacityKW: 21.4, compressorKW: 8.2, waterFlowLPS: 0.9, waterPressureDropKPa: 17.3 },
    ...
    '7.8': {
      ...
      '46': { capacityKW: 22.9, compressorKW: 7.9, waterFlowLPS: 0.9, waterPressureDropKPa: 18.6 },
      '48': { capacityKW: 22.3, compressorKW: 8.3, waterFlowLPS: 0.9, waterPressureDropKPa: 18.0 },
      '52': { capacityKW: 21.0, compressorKW: 9.0, waterFlowLPS: 0.9, waterPressureDropKPa: 16.6 },
    },
    '8.8': {
      '35': { capacityKW: 26.8, compressorKW: 6.4, waterFlowLPS: 1.2, waterPressureDropKPa: 24.2 },
      ...
      '52': { capacityKW: 21.6, compressorKW: 9.1, waterFlowLPS: 0.9, waterPressureDropKPa: 17.3 },
    },
    '10': {
      ...
      '46': { capacityKW: 24.7, compressorKW: 7.8, waterFlowLPS: 1.1, waterPressureDropKPa: 20.7 },
      '48': { capacityKW: 24.1, compressorKW: 8.4, waterFlowLPS: 1.0, waterPressureDropKPa: 20.7 },
      '52': { capacityKW: 22.3, compressorKW: 9.1, waterFlowLPS: 0.9, waterPressureDropKPa: 17.9 },
    },
  },
  'ACC-010': {
    '4.5': {
      '35': { capacityKW: 32.5, compressorKW: 8.6, waterFlowLPS: 1.4, waterPressureDropKPa: 25.5 },
      '40': { capacityKW: 30.6, compressorKW: 9.8, waterFlowLPS: 1.3, waterPressureDropKPa: 20.0 },
      '46': { capacityKW: 28.1, compressorKW: 11.0, waterFlowLPS: 1.4, waterPressureDropKPa: 18.6 },
      '48': { capacityKW: 28.1, compressorKW: 11.5, waterFlowLPS: 1.2, waterPressureDropKPa: 18.6 },
      '52': { capacityKW: 26.6, compressorKW: 12.5, waterFlowLPS: 1.1, waterPressureDropKPa: 15.9 },
    },
    '5.6': {
      '35': { capacityKW: 33.8, compressorKW: 8.7, waterFlowLPS: 1.5, waterPressureDropKPa: 25.5 },
      '40': { capacityKW: 31.8, compressorKW: 9.8, waterFlowLPS: 1.4, waterPressureDropKPa: 22.8 },
      '46': { capacityKW: 31.2, compressorKW: 11.1, waterFlowLPS: 1.5, waterPressureDropKPa: 20.0 },
    ...
    '6.7': {
      ...
      '40': { capacityKW: 33.1, compressorKW: 9.9, waterFlowLPS: 1.4, waterPressureDropKPa: 24.9 },
      '46': { capacityKW: 31.0, compressorKW: 11.1, waterFlowLPS: 1.3, waterPressureDropKPa: 22.1 },
    ...
    '8.8': {
      ...
      '40': { capacityKW: 35.6, compressorKW: 10.1, waterFlowLPS: 1.6, waterPressureDropKPa: 29.0 },
      '46': { capacityKW: 30.6, compressorKW: 11.4, waterFlowLPS: 1.4, waterPressureDropKPa: 26.2 },
    ...
    '10': {
      '35': { capacityKW: 39.0, compressorKW: 9.0, waterFlowLPS: 1.7, waterPressureDropKPa: 33.1 },
      '40': { capacityKW: 36.9, compressorKW: 10.1, waterFlowLPS: 1.6, waterPressureDropKPa: 31.1 },
      '46': { capacityKW: 30.4, compressorKW: 11.4, waterFlowLPS: 1.4, waterPressureDropKPa: 28.3 },
  ...
  'ACC-012': {
    '4.5': {
      ...
      '40': { capacityKW: 38.4, compressorKW: 12.5, waterFlowLPS: 1.7, waterPressureDropKPa: 36.6 },
    ...
    '6.7': {
      ...
      '40': { capacityKW: 41.2, compressorKW: 12.5, waterFlowLPS: 1.8, waterPressureDropKPa: 42.1 },
      '46': { capacityKW: 38.4, compressorKW: 14.1, waterFlowLPS: 1.6, waterPressureDropKPa: 36.6 },
    ...
    '7.8': {
      '35': { capacityKW: 43.9, compressorKW: 11.1, waterFlowLPS: 1.9, waterPressureDropKPa: 51.1 },
      '40': { capacityKW: 42.7, compressorKW: 12.6, waterFlowLPS: 1.8, waterPressureDropKPa: 44.9 },
      '46': { capacityKW: 40.5, compressorKW: 14.2, waterFlowLPS: 1.7, waterPressureDropKPa: 39.4 },
      '48': { capacityKW: 40.5, compressorKW: 14.8, waterFlowLPS: 1.7, waterPressureDropKPa: 38.0 },
      '52': { capacityKW: 37.4, compressorKW: 16.0, waterFlowLPS: 1.6, waterPressureDropKPa: 33.1 },
    },
    '8.8': {
      '35': { capacityKW: 43.9, compressorKW: 11.2, waterFlowLPS: 1.9, waterPressureDropKPa: 53.0 },
      '40': { capacityKW: 44.1, compressorKW: 12.6, waterFlowLPS: 1.8, waterPressureDropKPa: 47.6 },
      '46': { capacityKW: 41.5, compressorKW: 14.3, waterFlowLPS: 1.8, waterPressureDropKPa: 42.1 },
    ...
    '10': {
      ...
      '40': { capacityKW: 43.2, compressorKW: 12.7, waterFlowLPS: 1.8, waterPressureDropKPa: 50.4 },
      '46': { capacityKW: 42.7, compressorKW: 14.5, waterFlowLPS: 1.8, waterPressureDropKPa: 44.9 },
      '48': { capacityKW: 45.9, compressorKW: 14.9, waterFlowLPS: 1.9, waterPressureDropKPa: 43.5 },
      '52': { capacityKW: 40.9, compressorKW: 16.1, waterFlowLPS: 1.8, waterPressureDropKPa: 38.7 },
    },
  },
  'ACC-015': {
    '4.5': {
    ...
    '5.6': {
      ...
      '48': { capacityKW: 43.7, compressorKW: 16.8, waterFlowLPS: 1.9, waterPressureDropKPa: 24.2 },
      '52': { capacityKW: 43.7, compressorKW: 16.8, waterFlowLPS: 1.9, waterPressureDropKPa: 21.4 },
    },
    '6.7': {
      ...
      '48': { capacityKW: 45.1, compressorKW: 15.7, waterFlowLPS: 2.0, waterPressureDropKPa: 26.2 },
    ...
    '7.8': {
      ...
      '52': { capacityKW: 46.7, compressorKW: 17.0, waterFlowLPS: 2.0, waterPressureDropKPa: 26.2 },
    },
    '8.8': {
      ...
      '46': { capacityKW: 49.7, compressorKW: 15.3, waterFlowLPS: 2.1, waterPressureDropKPa: 33.1 },
    ...
    '10': {
      ...
      '40': { capacityKW: 55.3, compressorKW: 13.6, waterFlowLPS: 2.4, waterPressureDropKPa: 39.4 },
  ...
  'ACC-017': {
    ...
    '5.6': {
      ...
      '52': { capacityKW: 45.1, compressorKW: 20.4, waterFlowLPS: 1.9, waterPressureDropKPa: 25.5 },
    },
    '6.7': {
      ...
      '52': { capacityKW: 46.8, compressorKW: 20.6, waterFlowLPS: 2.0, waterPressureDropKPa: 29.0 },
    },
    '7.8': {
    ...
    '8.8': {
      ...
      '52': { capacityKW: 50.2, compressorKW: 21.0, waterFlowLPS: 2.2, waterPressureDropKPa: 29.0 },
    },
    '10': {
      ...
      '52': { capacityKW: 51.9, compressorKW: 21.0, waterFlowLPS: 2.3, waterPressureDropKPa: 35.2 },
    },
  },
};
