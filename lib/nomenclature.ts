...
function decodeGeneric(modelNumber: string, seriesId: string): NomenclatureSegment[] {
  const SERIES_MEANINGS: Record<string, string> = {
    ...
    'ngw-scroll': 'Air-Cooled Scroll Chiller',
    'wcc-scroll': 'Water-Cooled Scroll Chiller',
    'wcc-screw':  'Water-Cooled Screw Chiller',
    'ccu-std':    'Standard Condensing Unit',
    'ccu-lt':     'Low-Temperature Condensing Unit',
...
const SERIES_BOM_CONFIG: Record<string, SeriesBOMConfig> = {
  ...
  'ngw-scroll': { refrigerant: 'R410A', voltage: '415', phase: '3', frequency: '50', compressorType: 'SL' },
  'wcc-scroll': { refrigerant: 'R410A', voltage: '415', phase: '3', frequency: '50', compressorType: 'SL' },
  'wcc-screw':  { refrigerant: 'R134a', voltage: '415', phase: '3', frequency: '50', compressorType: 'SC' },
  'ccu-std':    { refrigerant: 'R404A', voltage: '415', phase: '3', frequency: '50', compressorType: 'SL' },
  'ccu-lt':     { refrigerant: 'R404A', voltage: '415', phase: '3', frequency: '50', compressorType: 'SL' },
